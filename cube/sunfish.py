...
def getMove(x,f,t):
    ...
    while True:
        ...
        # We query the user until he enters a (pseudo) legal move.
        move = None
        while move not in hist[-1].gen_moves():
            match = re.match('([a-h][1-8])'*2, f+t)
            if match:
        ...
        print("My move:", render__(119-move[0]) + render__(119-move[1]))
        hist.append(hist[-1].move(move))
        return tools.renderFEN(hist[-1])

if __name__ == '__getMove__':
    getMove()
